...
plt.show()
fig.savefig('Output/NumberOfShotsLaLiga.pdf', dpi=None, bbox_inches="tight")
...
plt.gca().set_aspect('equal', adjustable='box')
plt.show()
fig.savefig('Output/NumberOfGoalsSpainLeague.pdf', dpi=None, bbox_inches="tight")
...
plt.gca().set_aspect('equal', adjustable='box')
plt.show()
fig.savefig('Output/ProbabilityOfScoringLaLigaSpain.pdf', dpi=None, bbox_inches="tight")
